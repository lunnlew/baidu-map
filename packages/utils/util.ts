 ...
 * @returns
 */
export function mergePropsDefault(
    used_props: {
        [key: string]: any
    },
    define_props: {
...
interface AllEventMap {
    ...
    DrawingManager: BMapGL.DrawingManagerEvent,
}
...
type EventL = {
    addEventListener<U extends AllBMapGLType, T extends PickEvent<AllEventMap>>(
        event: T,
        handler: (e: any, obj: OnBMapGLPayload<U>) => void
    ): void
    removeEventListener<U extends AllBMapGLType, T extends PickEvent<AllEventMap>>(
        event: T,
        handler: (e: any, obj: OnBMapGLPayload<U>) => void
    ): void
}
 ...
 * @param emit Function
 */
export function bindEvents<U, T extends PickEvent<AllEventMap>>(
    obj: U,
    events: T[],
